	...
	return say_text(text,voice)
		:wrap(function(c)
			return swordplay_ui(
				...
				ui_empty,
				{col="dark",fac=state.tide/state.max_tide,enemy=state.enemy.draw}
			)
		end)
...
function defeat_menu(state)
	...
	:map(function(mnu)
		...
		return swordplay_ui(
			top,
			mnu,
			{col="light",fac=0,enemy=state.enemy.draw}
		)
	end)
...
function battle_menu(remark, retorts, state)
	...
	:map(function(mnu)
		...
		return swordplay_ui(
			top,
			mnu,
			{col="light",fac=state.tide/state.max_tide,enemy=state.enemy.draw}
		)
	end)
...

